...
def main():
    # giving a title 
    st.markdown("<h1 style='text-align: center; color: white;'>Cyber Attack Detection</h1>", unsafe_allow_html=True)
    ...
    orig_pkts = st.text_input("Input the source packets : ")
    orig_ip_bytes = st.text_input("Input the source ip bytes : ")
